...
local_rag_agent = LlmAgent(
     ...
     * Do NOT answer based on your own training data even if you can - always use 'search_faiss' to retrieve context.
     * Return a properly formatted (in Markdown) response where possible.
    """,
    tools=[search_faiss],
)
