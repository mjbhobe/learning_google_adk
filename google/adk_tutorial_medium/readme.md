# Developing Applications with Google ADK in 2026
...
* Check the updated weather at your destination city - you may now need to carry an umbrella as it will be raining by the time you reach your destination.

In the new _agentic era_, you send just one message to your agent - _my flight is delayed by 2 hours. Handle it_ and the agent will do all the above things you'd handle manually otherwise - no clicking, no switching tabs, no filling out forms. Just a goal, and an agent that figures out the rest. Sweet!
